...
export default function About() {
  return (
    <>
      {/* SEO */}
      <Head>
        <title>About SM Rice Pakistan | Premium Rice Suppliers & Exporters</title>
        <meta
          name="description"
          content="S.M Rice Trading – Explore premium Pakistani basmati and non-basmati rice. Discover our history, expert team, high-quality products, and trusted global partnerships for authentic South Asian flavors."
        />
        <meta
          name="keywords"
          content="SM Rice about, rice suppliers Pakistan, basmati rice exporters, rice trading Lahore, Pakistani rice company"
        />
        <meta name="robots" content="index, follow" />

        {/* Open Graph for social media */}
        <meta property="og:title" content="About SM Rice Pakistan" />
        <meta
          property="og:description"
          content="Discover S.M Rice Trading – premium Pakistani rice suppliers and exporters. Learn about our history, team, and global partnerships."
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Organization",
              "name": "S.M Rice Trading",
              "url": "https://www.smricetraders.com/", 
              "logo": "https://www.smricetraders.com/logo.png",
              "sameAs": [
                "https://www.facebook.com/smricetrading",
                "https://www.instagram.com/smricetrading"
              ],
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+923394021057",
                "contactType": "customer service",
                "email": "smricetraders0@gmail.com"
              },
              "address": {
                "@type": "PostalAddress",
                "streetAddress": "Samnabad main Los nala road",
        ...
        <div className="max-w-7xl mx-auto px-6 pb-20 relative z-10">
          ...
          <section className="bg-[#F5F0E6] p-8 md:p-10 rounded-lg shadow-sm mb-16 animate-slide-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center border border-[#E5D3B3]">
                <div className="relative h-24 w-24 md:h-32 md:w-32 mx-auto mb-4 rounded-full overflow-hidden">
                  <Image src="/team-manager.jpg" alt="Mr. Noman Cheema" fill className="object-cover" />
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center border border-[#E5D3B3]">
                <div className="relative h-24 w-24 md:h-32 md:w-32 mx-auto mb-4 rounded-full overflow-hidden">
                  <Image src="/teamexpert.jpg" alt="Mr. Luqman Cheema" fill className="object-cover" />
                </div>
