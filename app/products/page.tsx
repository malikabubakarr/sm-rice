...
export default function ProductPage() {
  ...
  return (
    <>
      {/* SEO */}
      <Head>
        <title>Premium Rice Products | SM Rice Pakistan</title>
        <meta
          name="description"
          content="Discover premium quality rice products by SM Rice. Perfect for home cooking and export quality. Order the finest rice in Pakistan."
        />
        <meta
          name="keywords"
          content="SM Rice, premium rice, basmati rice, rice export, rice Pakistan, buy rice online"
        />
        <meta name="author" content="SM Rice" />
        <meta name="robots" content="index, follow" />

        {/* Open Graph */}
        <meta property="og:title" content="Premium Rice Products | SM Rice Pakistan" />
        <meta
          property="og:description"
          content="Discover premium quality rice products by SM Rice. Perfect for home cooking and export quality."
        />
        ...
        <meta name="twitter:title" content="Premium Rice Products | SM Rice Pakistan" />
        <meta
